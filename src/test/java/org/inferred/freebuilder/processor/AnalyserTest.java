...
public class AnalyserTest {
  ...
  public void emptyDataType() throws CannotGenerateCodeException {
    ...
    Metadata expectedMetadata = new Metadata.Builder()
        ...
        .setPartialType(expectedBuilder.nestedType("Partial").withParameters())
        .setPropertyEnum(expectedBuilder.nestedType("Property").withParameters())
        .setType(QualifiedName.of("com.example", "DataType").withParameters())
        .setValueType(expectedBuilder.nestedType("Value").withParameters())
        .build();
